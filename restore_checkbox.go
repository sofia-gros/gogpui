...
func main() {
	// Restore checkbox from scratch with all fixes
	checkboxContent := `package checkbox
...
`
	ioutil.WriteFile("components/checkbox/checkbox.go", []byte(checkboxContent), 0644)
	fmt.Println("Fixed checkbox.go")
}
